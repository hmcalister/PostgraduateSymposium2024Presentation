...
\newcommand\fillColor{cyan!10!white}
...
\input{slides/02_modern_behavior.tex}
\input{slides/03_hyperparameter_search.tex}
\input{slides/04_stabilization.tex}
\input{slides/05_results.tex}
