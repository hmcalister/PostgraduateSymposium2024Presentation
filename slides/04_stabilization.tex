...
\begin{frame}
    ...
    \only<5>{
        \begin{gather*}
            \tanh \left[ \sum_{\mu} \left( f_n \left(\frac{\textcolor{red}{\boldsymbol \beta}}{N} \left(\zeta_{\mu, i} + \sum_{j \neq i} \zeta_{\mu, j} \xi_{j} \right) \right) - f_n \left(\frac{\textcolor{red}{\boldsymbol \beta}}{N} \left( -\zeta_{\mu, i} + \sum_{j \neq i} \zeta_{\mu, j} \xi_{j} \right) \right) \right) \right]
        \end{gather*}
    }
\end{frame}
